...
// Start here! 
const textContainer = document.querySelector(".text-container") as HTMLUListElement
const promoTexts = document.querySelectorAll(".promotion-texts>li") as NodeList
